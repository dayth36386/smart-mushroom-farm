...
<head>
   ...
   <title>Visualization Products</title>
...
<?php include 'header.php'; ?>
  <div class="ctn">
    <div class="box1">
      <video src="img/AdobeStock_224410807.mov" autoplay loop muted></video>
      <div class="text-overlay">
        <h1>Visualization Products</h1>
      </div>
    </div>
    <div class="box2">
      <div class="sbox1">
        <?php include 'charts/chartsproducts.php'; ?>
      </div> 
    </div>
  </div>
</body>
