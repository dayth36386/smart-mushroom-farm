...
<head>
   ...
   <title>Visualization Temp & Humi</title>
...
<body>
  ...
  <div class="ctn">
    <div class="box1">
      <video src="img/AdobeStock_442826645.mov" autoplay loop muted></video>
      <div class="text-overlay">
        <h1>Visualization Temp & Humi</h1>
      </div>
    </div>
    <div class="box2">
      <div class="sbox1">
        <?php include 'charts/chartstempandhumi.php'; ?>
      </div> 
    </div>
  </div>
</body>
